export const negocios = [
  ...
  },
  {
    ...
    destacado: true,
    rating: 5.0,
    logo: "/media/negocios_media/NGAE/LOGO_NGAE.png",
    ...
    galeria: [
      "/media/negocios_media/NGAE/Artesania_1.jpg",
      "/media/negocios_media/NGAE/Artesania_Abanico.jpg",
      "/media/negocios_media/NGAE/Artesania_Canastas.jpg",
      "/media/negocios_media/NGAE/Artesania_Aretes.jpg",
    ],
    contacto: {
  ...
  },
  {
    ...
    destacado: true,
    rating: 5.0,
    logo: "/media/negocios_media/NGAE/NGAE-Artesanal.png",
    portada: "/media/negocios_media/NGAE/Paletas.jpg",
    ...
    galeria: [
      "/media/negocios_media/NGAE/Asai.jpg",
      "/media/negocios_media/NGAE/Paletas.jpg",
